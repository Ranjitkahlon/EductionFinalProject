...
namespace EductionFinalProject.Controllers
{
    public class QueriesController : Controller
    {
        ...
        public QueriesController(EductionFinalProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Product,Email,Message")] Query query)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Product,Email,Message")] Query query)
        {
            if (id != query.id)
            {
                return NotFound();
