...
namespace EductionFinalProject.Controllers
{
    public class RegistersController : Controller
    {
        ...
        public RegistersController(EductionFinalProjectContext context)
        {
            _context = context;
        }
        ...
        public ActionResult Validate(Register admin)
        {
            var _admin = _context.Register.Where(s => s.userName == admin.userName);
            if (_admin.Any())
            {
        ...
        public async Task<IActionResult> Create([Bind("id,userName,Password")] Register register)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,userName,Password")] Register register)
        {
            if (id != register.id)
            {
                return NotFound();
